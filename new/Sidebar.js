...
import { decryptData } from "../../assets/security/encryDecrypt.js";
...
export default function Sidebar() {
  ...
  // const roleId=decryptData(encryptedId);
  ...
  const linksForAdmin = [
    ...
    },
    {
      path: "/migrationForm",
      icon: "fas fa-book",
      text: "Student Migration Form",
    },
    {
      path: "/addCourse",
      icon: "fas fa-book",
      text: "Add Course Form",
    },
    {
      path: "/viewStudent",
      icon: "fas fa-book",
        ...
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              {roleId == 2 &&
                linksForTeacher.map((link, index) => (
                  <li key={index} className="items-center">
                    <Link
                      className={
                        "text-xs uppercase py-3 font-bold block " +
